        ...
        <>
            ...
            <div className="w-full h-screen flex justify-center items-center bg-black bg-opacity-25">
                ...
                <form action="" className="p-6">
                    <input type="text" name="" placeholder="Username" className="py-2 px-3 w-full text-black text-lg font-light outline-none"/>{...register("username", {required: true})}
                    <input type="email" name="" placeholder="Email" className="py-2 px-3 w-full text-black text-lg font-light outline-none mt-3"/>{...register("email", {required: true})}
                    <input type="password" name="" placeholder="Password" className="py-2 px-3 w-full text-black text-lg font-light outline-none mt-3"/>{...register("password", {required: true})}
                    <input type="password" name="" placeholder="Confirm Password" className="py-2 px-3 w-full text-black text-lg font-light outline-none mt-3"/>{...register("confirmPassword", {required: true})}
